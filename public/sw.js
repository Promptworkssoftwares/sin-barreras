const CACHE = 'sin-barreras-v1.5.2';
const ASSETS = [
  '/', '/manifest.webmanifest', '/css/landing.css?v=1.5.2', '/js/landing.js?v=1.5.2',
  '/styles.css?v=1.5.2', '/app-bootstrap.js?v=1.5.2', '/cloud.js?v=1.5.2', '/account-ui.js?v=1.5.2',
  '/app.js?v=1.5.2', '/phrasebook.js?v=1.5.2', '/qr-conversation.js?v=1.5.2', '/ai-stage.js?v=1.5.2', '/audio-playback.js?v=1.5.2', '/navigation-flow.js?v=1.5.2', '/play-billing.js?v=1.5.2', '/languages.js?v=1.5.2', '/learn.js?v=1.5.2', '/sounds.js?v=1.5.2', '/voice-turn.js?v=1.5.2', '/icons/icon-192.png', '/icons/icon-512.png',
  ...
  '/offline-phrases.html', '/css/offline-phrases.css?v=1.5.2', '/js/offline-phrases.js?v=1.5.2', '/css/room.css?v=1.5.2', '/js/join-conversation.js?v=1.5.2'
];
