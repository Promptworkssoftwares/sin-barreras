const CACHE = 'sin-barreras-v1.6.4';
const ASSETS = [
  '/', '/manifest.webmanifest', '/css/landing.css?v=1.6.4', '/js/landing.js?v=1.6.4',
  '/styles.css?v=1.6.4', '/app-bootstrap.js?v=1.6.4', '/cloud.js?v=1.6.4', '/account-ui.js?v=1.6.4',
  '/app.js?v=1.6.4', '/learner-feedback.js?v=1.6.4', '/phrasebook.js?v=1.6.4', '/phrase-practice.js?v=1.6.4', '/qr-conversation.js?v=1.6.4', '/ai-stage.js?v=1.6.4', '/audio-playback.js?v=1.6.4', '/tts-cache.js?v=1.6.4', '/navigation-flow.js?v=1.6.4', '/play-billing.js?v=1.6.4', '/languages.js?v=1.6.4', '/learn.js?v=1.6.4', '/sounds.js?v=1.6.4', '/voice-turn.js?v=1.6.4', '/icons/icon-192.png', '/icons/icon-512.png',
  ...
  '/offline-phrases.html', '/css/offline-phrases.css?v=1.6.4', '/js/offline-phrases.js?v=1.6.4', '/css/room.css?v=1.6.4', '/js/join-conversation.js?v=1.6.4'
];
